...
Compute repeatability assuming that all files in the folder "data_to_compute_repeatability"
...
data_path = 'C://Users//juliette//Desktop//enpc//3A//S2//Nuage_de_points_et_modélisation_3D//projet//github//data//data_to_compute_repeatability' # Path of the file
